...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Api Key'), ['action' => 'edit', $apiKey->key]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Api Key'), ['action' => 'delete', $apiKey->key], ['confirm' => __('Are you sure you want to delete # {0}?', $apiKey->key)]) ?> </li>
